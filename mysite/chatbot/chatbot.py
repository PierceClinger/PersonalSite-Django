...
def logic(question):
    ...
    df = pandas.read_csv(f"mysite/chatbot/embs0.csv")
    ...
    df.to_csv("mysite/chatbot/embs0.csv")
    ...
    df2.to_csv("mysite/chatbot/embs0.csv")
    df2 = pandas.read_csv("mysite/chatbot/embs0.csv")
